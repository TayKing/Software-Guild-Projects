...
namespace Exercises.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult EditMajor(Major major)
        {
            ...
            {
                var model = MajorRepository.Get(major.MajorId);
                return View(model);
            }
        }
        ...
        {
            var state = StateRepository.Get(stateabbr);

            var model = new State();
            model.StateAbbreviation = state.StateAbbreviation;
        ...
        public ActionResult EditState(State state)
        {
            ...
            {
                var current = StateRepository.Get(state.StateAbbreviation);

                var model = new State();
                model.StateAbbreviation = current.StateAbbreviation;
                model.StateName = current.StateName;
        ...
        public ActionResult EditCourse(Course course)
        {
            ...
            {
                var model = CourseRepository.Get(course.CourseId);
                return View(model);
            }           
        }
